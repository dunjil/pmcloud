...
class Jobtas(models.Model):
    job_num = models.ForeignKey(Jobhdr, on_delete=models.CASCADE, db_column='JOB_NUM', unique=False, blank=True, null=True)
...
class Orgtbl(models.Model):
    ...
    orgn_code = models.CharField(max_length=100, blank=True, null=True)
